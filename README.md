...
1. Download the pre-compiled package from the release page: [poly_15min_bot.zip](https://github.com/rvenandowsley/Polymarket-crypto-15min-arbitrage-bot/releases/download/V1.3/poly_15min_bot.zip)
...
git clone https://github.com/rvenandowsley/Polymarket-crypto-15min-arbitrage-bot.git && cd Polymarket-crypto-15min-arbitrage-bot
...
```bash
git clone https://github.com/rvenandowsley/Polymarket-crypto-15min-arbitrage-bot.git
cd Polymarket-crypto-15min-arbitrage-bot
```
